...
#define DELTA_DIAGONAL_ROD 212.5 // mm
...
#define TEMP_SENSOR_BED 4 // using NTC 3950
...
#define MANUAL_Z_HOME_POS 270.5  // Distance between nozzle and print surface after homing.
